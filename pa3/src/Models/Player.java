...
public class Player {
	...
	public void initiateTrade() {
		...
		Deed cPlayerDeeds[];
		Deed tPlayerDeeds[];
		int cDeedsSize = cPlayerDeeds.length; // warning: cPlayerDeeds may not have been initialized
		int tDeedsSize = tPlayerDeeds.length; // warning: tPlayerDeeds may not have been initialized
