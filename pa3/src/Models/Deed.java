...
public class Deed extends Tile {
	...
	// constructor
	public Deed(int saleValue, int propertySet, int baseRent, int rentWithOneHouse, int rentWithTwoHouses,
			int rentWithThreeHouses, int rentWithFourHouses, int rentWithHotel, int mortgageValue, int houseCost,
			int hotelCost, String name, int position) {
	...
	/*
	 * returns the color set of the property legend: 0: brown 1: light blue 2: pink
	 * 3: orange 4: red 5: yellow 6: green 7: dark blue 8: RR 9: Utility
	 */
